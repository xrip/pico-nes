...
function(family_filter2 RESULT DIR)
...
function(family_add_subdirectory2 DIR)
...
function(family_get_project_name2 OUTPUT_NAME DIR)
  get_filename_component(SHORT_NAME ${DIR} NAME)
  set(${OUTPUT_NAME} ${TINYUSB_FAMILY_PROJECT_NAME_PREFIX}${SHORT_NAME} PARENT_SCOPE)
endfunction()


function(family_initialize_project2 PROJECT DIR)
...
# Add RTOS to example
function(family_add_rtos2 TARGET RTOS)
...
function(family_configure_common2 TARGET RTOS)
...
function(family_add_tinyusb2 TARGET OPT_MCU RTOS)
...
# Add bin/hex output
function(family_add_bin_hex2 TARGET)
  add_custom_command(TARGET ${TARGET} POST_BUILD
